...
<head>
	...
	<title>Admin Login Jabary</title>
...
<body class="login">
	<div class="wrapper wrapper-login">
		<div class="container container-login animated fadeIn">
			<h3 class="text-center">Admin Login Jabary</h3>
