...
<?php
    $r = mysqli_query($conn,"SELECT * FROM tbl_user");
...
<?php
    $g = mysqli_query($conn,"SELECT * from tbl_user");
...
<?php 
    ...
    if(isset($_POST['simpan']))
    {
        ...
        if(!$result){
                ...
                echo "<script>alert('Data berhasil ditambah.');window.location='?view=useradmin';</script>";
        }
    }
    ...
    elseif(isset($_POST['ubah']))
    {
        ...
        $query  = "UPDATE tbl_user SET username = '$username', password = '$pwd'";
        $query .= "WHERE id = '$id'";
        ...
        if(!$result){
                echo "<script>alert('Data gagal diubah.');window.location='?view=useradmin';</script>";
                 ...
                 echo "<script>alert('Data berhasil diubah.');window.location='?view=useradmin';</script>";
        }
    }
