    ...
    <div class="container">
        <div class="pt-5">
            ...
            <div class="kategoricaption mb-5">
                <div class="row">
                    <div class="col">
                        <h1 class="text-center fw-bold judulkategori">Makanan </h1>
                ...
                <div class="row">
                    <div class="col">
                        <h5 class="text-center px-3 isicaptionkategori">Keanekaragaman makanan khas Jawa Barat tak lepas dari dinamis masyarakat Sunda yang mendominasi wilayah tersebut. Makanan khas ini berkembang dan diperkenalkan dalam masyarakat secara turun-temurun.</h5>
                    </div>
                </div>
            </div>
        </div>
