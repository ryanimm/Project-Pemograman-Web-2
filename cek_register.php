...
$akunada=mysqli_query($conn,"SELECT * from tbl_user where username='$username'");
$cekakunada = mysqli_num_rows($akunada);

$filter=mysqli_query($conn,"SELECT * from tbl_admin_key where admin_key='$adminkey'");
...
if($cek>0){
    ...
    $query  = "INSERT INTO tbl_user (username, password,level) VALUES ('$username', '$pwd','admin')";
